    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/admin/boutique" className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <Link href="/admin/produit" className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
